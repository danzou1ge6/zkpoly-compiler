...
// template <>
// struct BaseTraits<UNSIGNED_INTEGER, false, false, mont::Number<8>, mont::Number<8>>
// {

//     typedef mont::Number<8> UnsignedBits;
//     static const Category       CATEGORY    = UNSIGNED_INTEGER;
//     static const mont::Number<8>   LOWEST_KEY;
//     static const mont::Number<8>   MAX_KEY;;
...
//     static __device__ __forceinline__ mont::Number<8> TwiddleIn(mont::Number<8> key)
//     {
//         return key;
//     }

//     static __device__ __forceinline__ mont::Number<8> TwiddleOut(mont::Number<8> key)
//     {
//         return key;
//     }

//     static __host__ __device__ __forceinline__ mont::Number<8> Max()
//     {
//         mont::Number<8> retval = MAX_KEY;
//         return reinterpret_cast<mont::Number<8>&>(retval);
//     }

//     static __host__ __device__ __forceinline__ mont::Number<8> Lowest()
//     {
//         mont::Number<8> retval = LOWEST_KEY;
//         return reinterpret_cast<mont::Number<8>&>(retval);
//     }
// };
// const mont::Number<8> BaseTraits<UNSIGNED_INTEGER, false, false, mont::Number<8>, mont::Number<8>>::LOWEST_KEY = {0, 0, 0, 0, 0, 0, 0, 0};
// const mont::Number<8> BaseTraits<UNSIGNED_INTEGER, false, false, mont::Number<8>, mont::Number<8>>::MAX_KEY = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
//                                                                                                             0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF};

// template <> struct NumericTraits<mont::Number<8>> : BaseTraits<UNSIGNED_INTEGER, false, false, mont::Number<8>, mont::Number<8>> {};
// }
...
//         CUDA_CHECK(cub::DeviceRadixSort::SortKeys(nullptr, temp_sort_size, temp_poly_ptr, useful_input_ptr, usable));
